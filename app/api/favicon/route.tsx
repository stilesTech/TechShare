...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://stiles.cc/favicons/zolplay.png',
  '(?:github.com)': 'https://stiles.cc/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://stiles.cc/favicons/twitter.png',
  'coolshell.cn': 'https://stiles.cc/favicons/coolshell.png',
  'vercel.com': 'https://stiles.cc/favicons/vercel.png',
  'nextjs.org': 'https://stiles.cc/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://stiles.cc/favicon_blank.png'
